...
function initSliders() {
  if (document.querySelector(".content-product__slider")) {
    new Swiper(".content-product__slider", {
      ...
      */
      // Пагінація
      pagination: {
        el: ".content-product__pagination",
        clickable: true,
        renderBullet: (index, className) => {
          return `<button class="${className}" aria-label="Go to page ${index + 1}"></button>`;
        }
      },
      // Скроллбар
      /*
